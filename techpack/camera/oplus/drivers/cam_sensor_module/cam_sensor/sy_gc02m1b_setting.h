.sy_gc02m1b_setting =
{
    .reg_setting =
    {
        ...
        {.reg_addr = 0x22, .reg_data = 0x07, .delay = 0x00, .data_mask = 0x00},
        ...
        {.reg_addr = 0x29, .reg_data = 0x08, .delay = 0x00, .data_mask = 0x00},
        {.reg_addr = 0x2a, .reg_data = 0x0a, .delay = 0x00, .data_mask = 0x00},
        {.reg_addr = 0x2b, .reg_data = 0x07, .delay = 0x00, .data_mask = 0x00},
        {.reg_addr = 0xfe, .reg_data = 0x01, .delay = 0x00, .data_mask = 0x00},

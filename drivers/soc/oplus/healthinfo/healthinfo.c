...
/******  Sched record  ******/
static inline void ohm_sched_stat_record_common(struct sched_stat_para
		*sched_stat, struct sched_stat_common *stat_common, u64 delta_ms)
{
...
#if defined(CONFIG_UFSFEATURE)
#if 0
static ssize_t ufsf_para_read(struct file *filp, char __user *buff,
			      size_t count,
			      loff_t *off)
{
	char page[1024] = {0};
